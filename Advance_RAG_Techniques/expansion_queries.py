...
chroma_collection = chroma_client.create_collection(
    "microsoft-collection", embedding_function=embedding_function  # type: ignore
)
...
for i, documents in enumerate(retrieved_documents): # type: ignore
...
result_embeddings = [item for sublist in retrieved_embeddings for item in sublist] # type: ignore
...
plt.scatter(
    project_original_query[0][0],
    project_original_query[0][1],
    s=150,
    marker="X",
    color="r",
)
